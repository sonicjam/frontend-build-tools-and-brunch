...
;
window.require.register("script", function(exports, require, module) {
  /*
  ...
  */
  ...
  document.addEventListener('DOMContentLoaded', function() {
    var highlight, resize;
    impress().init();
    hljs.initHighlightingOnLoad();
    resize = function() {
      var element, elements, innerHeight, innerWidth, _i, _len, _results;
      ...
      for (_i = 0, _len = elements.length; _i < _len; _i++) {
        ...
        _results.push(element.style.width = "" + innerWidth + "px");
      }
      return _results;
    };
    highlight = function() {
      ...
      for (_i = 0, _len = elements.length; _i < _len; _i++) {
        element = elements[_i];
        _results.push(hljs.highlightBlock(element));
      }
      return _results;
    };
